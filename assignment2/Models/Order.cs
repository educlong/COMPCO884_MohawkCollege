...
namespace assignment2.Models
{
    ...
    public partial class Order
    {
        ...
        [Column("order_date", TypeName = "datetime"), Display(Name ="Order")]
        [DataType(DataType.Date), DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
        public DateTime? OrderDate { get; set; }
        [Column("required_date", TypeName = "datetime")]
        public DateTime? RequiredDate { get; set; }
        [Column("shipped_date", TypeName = "datetime"), Display(Name = "Shipped")]
        [DataType(DataType.Date), DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
        ...
        [InverseProperty(nameof(Shipper.Orders)), Display(Name = "Shipper")]
